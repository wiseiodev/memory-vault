        ...
        <div className='flex flex-col gap-5'>
          ...
          <div className='max-w-3xl space-y-4'>
            ...
            <p className='text-lg leading-8 text-slate-700'>
              ...
              with the first production app living in <code>apps/web</code>.
            </p>
            <p className='max-w-2xl text-sm leading-7 text-slate-600'>
              ...
              Actions, and Lefthook wired from day one so follow-on tickets can
              focus on product behavior instead of repo plumbing.
            </p>
          </div>
        </div>
        ...
        <div className='grid gap-4 md:grid-cols-3'>
          ...
          <article className='rounded-3xl border border-slate-200/80 bg-white/90 p-5'>
            ...
            <p className='mt-3 text-sm leading-7 text-slate-700'>
              ...
              builds before changes move deeper into implementation.
            </p>
          </article>
        </div>
      </section>
